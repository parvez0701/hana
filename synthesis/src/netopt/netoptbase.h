...
#ifndef _NETOPTBASE_H_
#define _NETOPTBASE_H_
#include <set>
...
namespace opt
{
    class NetOptBase
    {
        ...
        public:
            ...
            virtual bool operator()(stview::SInst*) = 0;    
            virtual bool optimize(stview::SBlock *) = 0;    
        ...
        private:        
            NetOptBase(const NetOptBase&);
            NetOptBase& operator=(const NetOptBase&);
