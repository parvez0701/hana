...
#ifndef _SOPNANDTRANS_H_
#define _SOPNANDTRANS_H_

#include "soptransbase.h"

namespace SOP
{
    class SopNandTrans : public SopTransBase
    {
        public:
            virtual ~SopNandTrans() { }
            virtual SopNandTrans* copy() const { return new SopNandTrans(); }
