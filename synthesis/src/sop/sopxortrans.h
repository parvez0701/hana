...
#ifndef _SOPXORTRANS_H_
#define _SOPXORTRANS_H_
...
namespace SOP
{
    class SopXorTrans : public SopTransBase
    {
        public:
            virtual ~SopXorTrans() { }
            virtual SopXorTrans* copy() const { return new SopXorTrans(); }
            virtual void transform(const SInst *inst)
            {
                ...
                SExpr *expr = SExprTree::createNode(SExpr::OR, 0, 
